  ...
  return (
    <div style={{ position: 'fixed', top: '20px', left: '20px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
      {user && !isEmptyObject(user) ? (
        <>
          <div style={{ marginBottom: 15, display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
            ...
            <Button variant="outlined" onClick={() => setOpen(true)} sx={{ marginLeft:"15px",borderColor: 'pink', color: 'black', backgroundColor: 'transparent', transition: '0.3s', '&:hover': { backgroundColor: 'transparent', borderColor: 'black', color: 'pink' } }}>
              Update User
            </Button>
          </div>
